    ...
    async submit() {
        ...
        if (!toUserId) {
            if (window.EmailPopup && typeof EmailPopup.showToast === 'function') {
                ...
                Notifications.error('Por favor, selecione um colaborador');
            } else {
        ...
        if (!badge) {
            if (window.EmailPopup && typeof EmailPopup.showToast === 'function') {
                ...
                Notifications.error('Por favor, selecione um badge de reconhecimento');
            } else {
        ...
        if (badge === 'outro') {
            ...
            if (!customBadge) {
                if (window.EmailPopup && typeof EmailPopup.showToast === 'function') {
                    ...
                    Notifications.error('Por favor, digite o badge personalizado');
                } else {
        ...
        if (!message) {
            if (window.EmailPopup && typeof EmailPopup.showToast === 'function') {
                ...
                Notifications.error('Por favor, descreva o motivo do reconhecimento');
            } else {
        ...
        try {
            ...
            if (result.pointsEarned > 0) {
                ...
                Notifications.success('Reconhecimento enviado com sucesso!');
            }
        } catch (error) {
            ...
            if (window.EmailPopup && typeof EmailPopup.showToast === 'function') {
                ...
                Notifications.error('Erro ao enviar reconhecimento');
            } else {
